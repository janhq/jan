...
import { Confetti, ConfettiCanvas } from './components/confetti'
                ...
                {isPrivateChat ? (
                  <>
                    ...
                    >
                      ...
                      conversation history, can't use memory, and will be
                  ...
                  <div className="flex items-center justify-center">
                    <motion.h2
                      ...
                      className="text-2xl font-medium mb-6 font-studio mr-1"
                    >
                      {randomPhrase}
                    </motion.h2>
                    <motion.div
