...
import { TextArea, Button, Tooltip, useClickOutside } from '@janhq/joi'
        ...
        {experimentalFeature && (
          <Tooltip
            trigger={
              <PaperclipIcon
                size={20}
                className="absolute left-3 top-3.5 cursor-pointer text-[hsla(var(--app-icon))]"
                onClick={(e) => {
                  if (
                    fileUpload.length > 0 ||
            ...
            <ul>
              <Tooltip
                trigger={
                  <li
                    className={twMerge(
                      'text-[hsla(var(--app-text-secondary)] flex w-full items-center space-x-2 px-4 py-2 hover:bg-secondary',
                      activeThread?.assistants[0].model.settings.vision_model
                        ? 'cursor-pointer'
              ...
              <Tooltip
                trigger={
                  <li
                    className={twMerge(
                      'text-[hsla(var(--app-text-secondary)] flex w-full cursor-pointer items-center space-x-2 px-4 py-2 hover:bg-secondary',
