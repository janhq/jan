...
import { Check, ChevronsUpDown, Box, CloudIcon } from 'lucide-react'
import {
  DropDrawer,
  DropDrawerContent,
  DropDrawerItem,
    ...
    <DropDrawer open={open} onOpenChange={setOpen}>
      <DropDrawerTrigger asChild>
        <div className="relative">
          ...
          >
            {selectedModel?.providerId !== 'llamacpp' ? (
            ...
            <span
              className={
                selectedModel?.model_display_name || selectedModel?.name
                  ? 'truncate'
            ...
            {selectedModel?.providerId !== 'llamacpp' && <CloudIcon />}
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex flex-col items-start gap-0.5">
                        <span className="font-medium">
                          {model.model_display_name ?? model.name}
                        </span>
                        {
                          <span className="text-xs text-muted-foreground">
                            {model.owned_by ?? model.providerId}
                          </span>
                        }
                      </div>
                    </div>
