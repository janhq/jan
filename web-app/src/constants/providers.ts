...
export const predefinedProviders = [
  ...
  },
  {
    ...
    explore_models_url: 'https://novita.ai/models',
    provider: 'novita',
    settings: [
      {
        key: 'api-key',
        title: 'API Key',
        description:
          "The Novita API uses API keys for authentication. Visit your Novita dashboard to retrieve your key, or set NOVITA_API_KEY in your environment.",
        controller_type: 'input',
        controller_props: {
          placeholder: 'Insert API Key',
          value: '',
      ...
      },
      {
        ...
        title: 'Base URL',
        description:
          'The base OpenAI-compatible endpoint to use for Novita.',
        controller_type: 'input',
        controller_props: {
