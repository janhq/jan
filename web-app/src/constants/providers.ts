...
export const predefinedProviders = [
  ...
  },
  {
    ...
    explore_models_url: 'https://saygm.com',
    provider: 'saygm',
    settings: [
      {
        key: 'api-key',
        title: 'API Key',
        description:
          "The SayGM API uses API keys for authentication. Visit [SayGM](https://saygm.com) to retrieve the API key you'll use in your requests.",
        controller_type: 'input',
        controller_props: {
          placeholder: 'Insert API Key',
          value: '',
    ...
    models: [
      {
        ...
        name: 'GPT-5.4',
        version: '1.0',
        description: 'Frontier OpenAI-compatible model on SayGM.',
        capabilities: ['completion'],
      },
      {
        id: 'gpt-5.4-mini',
        name: 'GPT-5.4 Mini',
        version: '1.0',
        description: 'Compact OpenAI-compatible model on SayGM.',
        capabilities: ['completion'],
      },
      {
        id: 'gpt-5.4-nano',
        name: 'GPT-5.4 Nano',
        version: '1.0',
        description: 'Fastest OpenAI-compatible model on SayGM.',
        capabilities: ['completion'],
      },
      {
        id: 'gpt-5.5',
      ...
      },
      {
        ...
        name: 'GPT-5.6 Sol',
        version: '1.0',
        description: 'Flagship reasoning model on SayGM.',
        capabilities: ['completion'],
      },
      {
        id: 'gpt-5.6-luna',
        name: 'GPT-5.6 Luna',
        version: '1.0',
        description: 'Fast OpenAI-compatible model on SayGM.',
        capabilities: ['completion'],
      },
      {
        id: 'gpt-5.6-terra',
        name: 'GPT-5.6 Terra',
        version: '1.0',
        description: 'Balanced OpenAI-compatible model on SayGM.',
        capabilities: ['completion'],
      },
      {
        id: 'o3',
        name: 'o3',
        version: '1.0',
        description: 'High-intelligence reasoning model on SayGM.',
        capabilities: ['completion'],
      },
      {
        id: 'o4-mini',
        name: 'o4-mini',
        version: '1.0',
        description: 'Compact reasoning model on SayGM.',
        capabilities: ['completion'],
      },
    ],
  },
