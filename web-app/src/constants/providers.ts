...
export const predefinedProviders = [
  ...
  },
  {
    ...
    explore_models_url: 'https://inference.gitgot.ai/v1/models',
    provider: 'gitgot',
    settings: [
      {
        key: 'api-key',
        title: 'API Key',
        description:
          'The GitGot API uses API keys for authentication. Visit your [Dashboard](https://gitgot.ai/dashboard) to retrieve the API key you\'ll use in your requests.',
        controller_type: 'input',
        controller_props: {
          placeholder: 'Insert API Key',
          value: '',
