...
export const INTEGRATION_AGENTS: IntegrationAgent[] = [
  // Temporarily hidden from the Launch page (Claude Code, Codex CLI, Hermes
  // Agent, OpenClaw). Their install/configure wiring is kept intact; restore
  // by un-commenting the entries below.
  // {
  //   id: 'claude-code',
  //   name: 'Claude Code',
