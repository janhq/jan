...
export const ModelInfoHoverCard = ({
  ...
  // Parse the file_size string to bytes for calculations
  const sizeInBytes = displayVariant?.file_size
    ? parseSizeToBytes(displayVariant.file_size)
    : 0
    ...
    <HoverCard>
      ...
      <HoverCardContent className="w-96 p-4" side="left">
        <div className="space-y-4">
          ...
          {displayVariant?.file_size && sizeInBytes > 0 && (
            <div className="border-t border-main-view-fg/10 pt-3">
              ...
              <div className="grid grid-cols-2 gap-3 text-xs">
                <div>
                  <span className="text-main-view-fg/50 block">Model Size</span>
                  <span className="text-main-view-fg font-medium mt-1 inline-block">
                    {displayVariant.file_size}
                  </span>
                </div>
                <div>
                  <span className="text-main-view-fg/50 block">Estimated Speed / Time</span>
                  <span className="text-main-view-fg font-medium mt-1 inline-block">
                    {calculateDownloadSpeed()} / {calculateDownloadTime(sizeInBytes)}
                  </span>
                </div>
              </div>
              <p className="text-[10px] text-main-view-fg/40 mt-2">
