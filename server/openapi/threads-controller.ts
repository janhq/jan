...
export class ThreadsController extends Controller {
  ...
  public async getThreads() {
    return getBuilder(JanApiRouteConfiguration['threads']).then(normalizeData)
  }

  @Tags('Find thread by id')
  @Get(':id')
  public async findThreadById(@Path('id') id: string): Promise<any> {
    return retrieveBuilder(JanApiRouteConfiguration['threads'], id)
  }

  @Tags('Delete thread by id')
  @Delete(':id')
  public async deleteThreadById(
    @Path('id') id: string
