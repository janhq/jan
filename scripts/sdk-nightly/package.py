"""Build versioned SDK artifacts and snapshot their compatible runtime manifest.
...
def main():
    ...
    parser.add_argument("--base-url", default="https://delta.jan.ai/sdk-nightly")
    ...
    with tempfile.TemporaryDirectory(prefix="jan-sdk-package-") as temporary:
        stage = Path(temporary)
        js = stage / "javascript"
        shutil.copytree(ROOT / "packages/agent-sdk", js, ignore=shutil.ignore_patterns("node_modules"))
        ...
        py = stage / "python"
        shutil.copytree(ROOT / "sdk/python", py, ignore=shutil.ignore_patterns("__pycache__", "*.egg-info", "build", "dist"))
...
<title>Jan Agent SDK nightly</title>
...
<a href="https://jan.ai/docs/agent/sdk">SDK guides</a></p>
