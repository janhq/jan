"""Install downloaded ADK artifacts and drive their real runtime, without source imports."""
import argparse
import hashlib
import json
import os
...
def main():
    ...
    with tempfile.TemporaryDirectory(prefix="jan-adk-artifact-") as directory:
        root = Path(directory)
        artifacts = {}
