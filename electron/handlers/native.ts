...
import {getAllMessagesAndThreads, syncModelFileToCortex, getAllLocalModels} from './messages'
...
export function handleAppIPCs() {
  ...
  ipcMain.handle(NativeRoute.syncModelFileToCortex, syncModelFileToCortex)

  ipcMain.handle(
    NativeRoute.getAllMessagesAndThreads,
    getAllMessagesAndThreads
  )
