...
![Terminal showing JupyterLab startup](../../../../../assets/jupyter1.png)

The server opens in your browser:

![JupyterLab interface in browser](../../../../../assets/jupyter.png)

### Create Target Notebook

Create a new notebook named `for_jan.ipynb`:

![Notebook created in JupyterLab](../../../../../assets/jupyter2.png)
...
![Jan MCP server configuration](../../../../../assets/jupyter3.png)
...
![OpenAI settings page](../../../../../assets/openai-settings.png)

### Add GPT-5 Model

Since GPT-5 is new, you'll need to manually add it to Jan:

![Manually adding GPT-5 model name](../../../../../assets/gpt5-add.png)
...
![Enabling tools for GPT-5](../../../../../assets/gpt5-tools.png)
...
![GPT-5 ready in chat with Jupyter tools visible](../../../../../assets/gpt5-chat.png)
...
![First message showing successful tool use](../../../../../assets/gpt5-msg.png)
...
![Complex analysis with luxury fashion sales data](../../../../../assets/gpt5-msg2.png)
