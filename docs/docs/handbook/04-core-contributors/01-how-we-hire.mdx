...
- **Avoiding Bias**
- Be aware of "halo" and "horns" effects where first impressions unduly influence the entire interview. Tempting as it is to judge someone on the fact that they _also_ binge watched Severance, every role at Jan is a key hire- and should be interviewed to the same standard.
