---
title: Jan 0.4.4 Windows Bitdefender Flagging Issue
slug: /postmortem/jan-0-4-4-windows-bitdefender-flagging-issue
...
Following the recent incident related to Jan version 0.4.4 triggering Bitdefender on Windows with Gen:Variant.Tedy.258323, we wanted to provide a comprehensive postmortem and outline the necessary follow-up actions.
