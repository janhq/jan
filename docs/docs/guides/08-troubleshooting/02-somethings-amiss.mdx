...
4. Ensure your ports 3928 (Nitro inference engine) and 3001 (Jan client & API server) are accessible

5. Ensure your V/RAM is accessible by the application

6. If you are on Nvidia GPUs, please download [Cuda](https://developer.nvidia.com/cuda-downloads)
