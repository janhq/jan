...
Regardless of your analytics permissions, Jan will **never** access your chat history (which is stored locally on your device for your reference), chat settings, or the language models you have used.
