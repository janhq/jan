...
command = "./.jan/agent/hooks/branch.sh"
```
...
"hooks": [
  {
    ...
    "timeout_secs": 10,
    "source": "/home/you/code/app/.jan/agent/plugins/auditor/hooks/hooks.json"
  },
  {
    "event": "PostToolUse",
    "matcher": "edit",
    "command": "cargo fmt --quiet",
    "timeout_secs": 60,
    "source": "/home/you/code/app/.jan/agent/agent.toml"
  }
],
"plugin_tools": [
  {
    ...
    "description": "Render the changelog between two tags",
    "command": "./bin/changelog.sh",
    "source": "/home/you/code/app/.jan/agent/plugins/release-tools"
  }
]
```
