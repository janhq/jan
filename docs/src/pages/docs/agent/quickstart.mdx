...
<DocCards>
  ...
  <DocCard title="Tools & permissions" href="/docs/agent/tools" icon={<Wrench size={20} />}>What the agent can reach, and how to widen or narrow it.</DocCard>
  <DocCard title="Configuration" href="/docs/agent/configuration" icon={<Settings size={20} />}>Per-project instructions, models, and budgets.</DocCard>
