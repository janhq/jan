...
| `/usage` | Show this session's tokens and estimated cost, per model. Priced from what the provider publishes; a model it publishes no price for is listed as such rather than counted as free |
