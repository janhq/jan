...
import { Settings, Trash2, EllipsisVertical, Cpu, Zap, Sparkles, Brain, Globe, Network, Wind, GitBranch, Shield } from 'lucide-react'
...
<DocCards cols={2}>
  ...
  <DocCard title="OrcaRouter" href="/docs/desktop/remote-models/orcarouter" icon={<Shield size={20} />}>Route to many models via one gateway, with built-in agent security.</DocCard>
</DocCards>
