...
| **Serply** | Required | Needs a [Serply](https://serply.io) API key. Returns Google results; `web_fetch` fetches the page directly, as with SearXNG. |
...
<Callout type="info">
For **Tavily** and **Serply**, an API key is required. For **SearXNG**, you provide your instance's base URL instead
