...
not included in stable releases yet. To try it, open the [latest nightly build
manifest](https://delta.jan.ai/nightly/latest.json) and choose the download for
your platform. Nightly builds may be unstable and can change without notice.
</Callout>
