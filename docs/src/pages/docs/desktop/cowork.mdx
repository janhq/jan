...
Cowork is in preview and is currently available only in Jan's nightly builds. It is
not included in stable releases yet. To try it, download the latest nightly build for
your platform: [macOS](https://app.jan.ai/download/nightly/mac-universal),
[Windows](https://app.jan.ai/download/nightly/win-x64),
[Linux (`.deb`)](https://app.jan.ai/download/nightly/linux-amd64-deb), or
[Linux (AppImage)](https://app.jan.ai/download/nightly/linux-amd64-appimage).
Nightly builds may be unstable and can change without notice.
</Callout>
