...
2. Enter it in **Settings > General > Others > HuggingFace Token**.

## Model Settings (Gear Icon)

![Model Settings](./_assets/model-settings-gear.png)
...
![HTTPs Proxy](./_assets/https-proxy-settings.png)
...
![Factory Reset](./_assets/factory-reset.png)
