...
Press **⌘ P** or click **New Projects** in the left sidebar.
...
Upload documents to a project and reference them in any conversation within it. Supported formats include PDFs, Markdown, Office documents (DOCX, XLSX, PPTX), code files, and more.

- Click **Add** in the Files panel to upload files
