...
<Callout type="info">
**Jan 0.7.8 is now live!** — CLI, and more. [See the full changelog.](/changelog/2026-03-11-jan-openclaw-cli-context)
</Callout>
...
<DocCards>
  ...
  <DocCard title="Integrations" href="/docs/desktop/integrations/claude-code" icon={<Plug size={20} />}>Connect Jan with Claude Code, MCP servers, and more.</DocCard>
</DocCards>
