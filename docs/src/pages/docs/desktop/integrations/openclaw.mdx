...
**Important: OpenClaw Integration Removed in Jan v0.7.9**

As of Jan v0.7.9, the OpenClaw integration has been discontinued and is no longer available. If you wish to use OpenClaw, please use **Jan v0.7.8**.

The Jan team is focusing on building a safe, stable, and practical agent experience for Jan. We appreciate your patience and support as we work toward delivering a more robust solution.
</Callout>
