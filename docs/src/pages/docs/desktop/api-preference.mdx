...
<DocCards cols={2}>
  ...
  <DocCard title="Codex" href="/docs/desktop/integrations/codex" icon={<Terminal size={20} />}>Point Codex at Jan's local server and run the coding agent through Jan's local OpenAI-compatible endpoint.</DocCard>
