...
Custom or forked `llama.cpp` backends can be installed manually for experimentation. First-class fork-specific integration will follow upstream `llama.cpp` support.
