---
title: Run AI models locally on Linux - Jan
description: Install Jan to run large language models locally on Linux. Offline AI with GPU acceleration support for Ubuntu, Debian, and other distributions.
keywords:
  [
    Jan,
