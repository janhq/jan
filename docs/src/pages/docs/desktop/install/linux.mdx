...
<div className="inline-flex flex-col gap-3">
  <DownloadButton href="https://github.com/janhq/jan/releases/download/v0.7.7/Jan_0.7.7_amd64.deb">Download Jan for Ubuntu / Debian</DownloadButton>
  <DownloadButton href="https://github.com/janhq/jan/releases/download/v0.7.7/Jan_0.7.7_amd64.AppImage">Download Jan AppImage</DownloadButton>
</div>
