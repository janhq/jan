---
title: Run AI models locally on Windows - Jan
description: Install Jan to run large language models locally on Windows PC. Offline ChatGPT-like AI with GPU acceleration support for Windows 10 and 11.
keywords:
  [
    Jan,
