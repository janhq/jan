...
4. In Jan, navigate to **Settings** (<Settings width={16} height={16} style={{display:"inline"}}/>) > **Model Providers** > **Llama.cpp**
5. Use the backend version selector to point at the extracted folder
6. Go to **Settings** (<Settings width={16} height={16} style={{display:"inline"}}/>) > **Hardware** and ensure GPU acceleration is enabled
