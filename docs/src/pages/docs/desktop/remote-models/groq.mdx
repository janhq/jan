...
Jan supports [Groq](https://groq.com/) API integration, allowing you to use Groq's high-performance LLM models (Llama 3.x, Qwen, DeepSeek and more) through Jan's interface.
...
![Groq](../_assets/provider-groq.png)
