---
title: OpenAI API
description: A step-by-step guide on integrating Jan with OpenAI.
keywords:
  [
    Jan,
...
2. Under **Model Providers**, select **OpenAI**
3. Insert your API Key

![OpenAI](../_assets/provider-openai.png)

### Step 3: Start Using OpenAI's Models

1. In any existing **Chat** or create a new one
2. Select an OpenAI model from the **model selector**
3. Start chatting
