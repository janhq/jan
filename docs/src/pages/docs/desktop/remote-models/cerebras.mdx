...
### Production Models
- **Llama 4 Scout** (`llama-4-scout-17b-16e-instruct`) - 109B parameters, ~2600 tokens/s
...
- **Qwen 3 Coder 480B** - 480B parameters, ~2000 tokens/s
...
### Tool Calling
Cerebras supports tool calling (function calling) for:
- `gpt-oss-120b`
- `llama-3.3-70b`
