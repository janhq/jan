...
<ResearchPostLayout title="Jan-v2-VL">
...
<OpenInJanButton href="jan://models/huggingface/janhq/Jan-v2-VL-med-gguf" />
...
![Long Horizon Benchmark — Task Length Executed in Single Turn](../docs/desktop/_assets/jan-v2-vl-bench-1.png)

All three Jan-v2-VL variants significantly exceed the Qwen3-VL-8B-Thinking baseline (score: 5):

![Long Horizon Execution — variant comparison](../docs/desktop/_assets/jan-v2-vl-bench-2.png)

### Text-Only Benchmarks

Jan-v2-VL maintains strong performance on standard language benchmarks with no degradation from the base model:

![Text-Only Benchmarks — MMLU, SimpleQA, IF Bench, AIME25, EQ Bench, Creative Writing, SWE Bench](../docs/desktop/_assets/jan-v2-vl-bench-3.png)

### Multimodal Benchmarks

Core vision capabilities are fully preserved across all variants:

![Multimodal Performance — RealVQA, CountBench, OCR Bench](../docs/desktop/_assets/jan-v2-vl-bench-4.png)
