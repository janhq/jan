...
<ResearchPostLayout title="Jan-v3-4B">
...
<OpenInJanButton href="jan://models/huggingface/janhq/Jan-v3-4B-base-instruct-gguf" />
...
![Aider Benchmark — Jan-v3 leads with high efficiency](../docs/desktop/_assets/jan-v3-4b-overview.png)
...
![Performance Comparison vs. Qwen3-4B-Instruct-2507](../docs/desktop/_assets/jan-v3-4b-bench.png)
