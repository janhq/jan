...
<ResearchPostLayout title="Jan-Code-4B">
...
<OpenInJanButton href="jan://models/huggingface/janhq/Jan-code-4b-gguf" />
...
![Aider Benchmark, Livecode Bench v6, and AIME25 — Jan-Code vs. Jan-v3-base-instruct vs. Qwen3-4B-Instruct-2507](../docs/desktop/_assets/jan-code-4b-overview.png)
