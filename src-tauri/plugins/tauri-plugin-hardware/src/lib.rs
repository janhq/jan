...
pub struct GpuInfo {
    ...
    pub nvidia_info: Option<vendor::nvidia::NvidiaInfo>,
    pub vulkan_info: Option<vendor::vulkan::VulkanInfo>,
}
...
fn get_jan_libvulkan_path<R: Runtime>(app: tauri::AppHandle<R>) -> String {
