...
pub const LLAMA_CPP_TAG: &str = "b10964";
pub const LLAMA_CPP_BUILD_NUMBER: u32 = 10964;
pub const LLAMA_CPP_COMMIT: &str = "b29c606e28a01b1bc8c1351026a0fa6e616bf6c4";
pub const LLAMA_CPP_VERSION: &str = "0.4.1";
