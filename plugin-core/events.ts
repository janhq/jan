 ...
 */
const on: (eventName: EventName, handler: Function) => void = (eventName, handler) => {
 ...
 * @param handler The handler function to call when the event is observed.
 */
const off: (eventName: EventName, handler: Function) => void = (eventName, handler) => {
 ...
 */
const emit: (eventName: EventName, object: any) => void = (eventName, object) => {
